...
IL_0018:
	{
		...
		memset(&L_11, 0, sizeof(L_11));
		Rect__ctor_m1220545469(&L_11, ((float)((float)(((float)((float)L_6)))*(float)(0.26f))), ((float)((float)((float)((float)(((float)((float)L_7)))*(float)(0.32f)))+(float)L_8)), ((float)((float)(((float)((float)L_9)))*(float)(0.6f))), ((float)((float)(((float)((float)L_10)))*(float)(0.08f))), /*hidden argument*/NULL);
		MatchInfoSnapshot_t3179110907 * L_12 = V_2;
		NullCheck(L_12);
		String_t* L_13 = MatchInfoSnapshot_get_name_m2408180236(L_12, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		String_t* L_14 = String_Concat_m2596409543(NULL /*static, unused*/, _stringLiteral1235961479, L_13, /*hidden argument*/NULL);
	...
	{
		NetworkManager_t3335581469 * L_16 = __this->get_manager_2();
		MatchInfoSnapshot_t3179110907 * L_17 = V_2;
		NullCheck(L_17);
		String_t* L_18 = MatchInfoSnapshot_get_name_m2408180236(L_17, /*hidden argument*/NULL);
		NullCheck(L_16);
		L_16->set_matchName_30(L_18);
		NetworkManager_t3335581469 * L_19 = __this->get_manager_2();
		NullCheck(L_19);
		NetworkMatch_t259788815 * L_20 = L_19->get_matchMaker_41();
		MatchInfoSnapshot_t3179110907 * L_21 = V_2;
		NullCheck(L_21);
		uint64_t L_22 = MatchInfoSnapshot_get_networkId_m940548281(L_21, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		...
		NetworkManager_t3335581469 * L_26 = __this->get_manager_2();
		NetworkManager_t3335581469 * L_27 = L_26;
		IntPtr_t L_28;
		L_28.set_m_value_0((void*)(void*)GetVirtualMethodInfo(L_27, 29));
		DataResponseDelegate_1_t3220115103 * L_29 = (DataResponseDelegate_1_t3220115103 *)il2cpp_codegen_object_new(DataResponseDelegate_1_t3220115103_il2cpp_TypeInfo_var);
		DataResponseDelegate_1__ctor_m1222355432(L_29, L_27, L_28, /*hidden argument*/DataResponseDelegate_1__ctor_m1222355432_MethodInfo_var);
		NullCheck(L_20);
		NetworkMatch_JoinMatch_m4137052469(L_20, L_22, L_23, L_24, L_25, 0, 0, L_29, /*hidden argument*/NULL);
		GameObject_t1756533147 * L_30 = __this->get_ui_5();
		NullCheck(L_30);
